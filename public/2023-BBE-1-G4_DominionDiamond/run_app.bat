...
git clone --single-branch --branch docker https://github.com/CampusDual/2023-BBE-1-G4_DominionDiamond
echo ==== Limpiando imagenes antiguas (4/9) ====
wsl.exe docker image rm 2023-bbe-1-g4-db
wsl.exe docker image rm 2023-bbe-1-g4-backend
echo ==== Creando la imagen de la BBDD (5/9) ====
cd "%initial_dir%\temp\2023-BBE-1-G4_DominionDiamond\dominiondiamondhotel\dominiondiamondhotel-model\src\main\db"
wsl.exe docker build -t 2023-bbe-1-g4-db .
echo ==== Creando la imagen del backend (6/9) ====
cd "%initial_dir%\temp\2023-BBE-1-G4_DominionDiamond\dominiondiamondhotel"
wsl.exe docker build -t 2023-bbe-1-g4-backend .
