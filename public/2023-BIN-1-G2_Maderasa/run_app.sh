...
docker image rm 2023-bin-1-g2-db
docker image rm 2023-bin-1-g2-backend
docker image rm 2023-bin-1-g2-frontend
echo "==== Creando la imagen de la BBDD (5/10) ===="
cd "$initial_dir/temp/2023-BIN-1-G2_Maderasa/backend/hr-model/src/main/db"
docker build -t 2023-bin-1-g2-db .
echo "==== Creando la imagen del backend (6/10) ===="
cd "$initial_dir/temp/2023-BIN-1-G2_Maderasa/backend"
docker build -t 2023-bin-1-g2-backend .
echo "==== Creando la imagen del frontend (7/10) ===="
cd "$initial_dir/temp/temp/2023-BIN-1-G2_Maderasa/frontend"
docker build -t 2023-bin-1-g2-frontend .
